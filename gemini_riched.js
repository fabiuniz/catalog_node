...
const KNOWLEDGE_FILE = 'catalogo_png.json';
...
const responseSchema = {
    ...
    items: {
        type: "OBJECT",
        properties: {
            "nome": { "type": "STRING", "description": "Nome da Game (ex: Mario World, Robocop)." },
            "descricao": { "type": "STRING", "description": "Descrição concisa do game ." },
        ...
        "required": ["nome", "descricao", "data_criacao", "link","ano","genero","plataformas","urlCompleta", "tags"]
    }
};
